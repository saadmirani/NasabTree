...
import palasiData from "../data/Naspalasi.json";
import familyInfo from "../data/familyInfo/palasi.json";
...
export default function NasabPalasi({ setSection, focusPersonId }) {
   ...
   return (
      <div className="nasab-wrapper">
         <Helmet>
            <title>Qasba Palasi - Genealogical Family Tree</title>
            <meta name="description" content="Interactive genealogical family tree for Qasba Qasba Palasi. Search for ancestors, descendants, biographical information, dates, and family relationships." />
            <meta name="keywords" content="Qasba Qasba Palasi, genealogy, family tree, ancestors, descendants, genealogical records" />
            <meta property="og:title" content="Qasba Qasba Palasi - Family Tree" />
            <meta property="og:description" content="Explore the genealogical family tree of Qasba Qasba Palasi with detailed biographical information." />
            <meta property="og:type" content="website" />
            <script type="application/ld+json">
               {JSON.stringify(generateFamilyTreeSchema(palasiData, QASBA_CONFIG.qasbaName))}
            </script>
            <script type="application/ld+json">
