...
import Data from "../data/bikopur.json";
import "../styles/tree.css"; import jsPDF from "jspdf";
...
export default function NasabBikopur({ setSection }) {
   ...
   const drawTree = useCallback(() => {
      try {
         ...
         console.log("Drawing tree for Bikopur data");
         ...
         console.error("Error drawing Bikopur tree:", error);
      }
   }, [handleNodeClick]);
