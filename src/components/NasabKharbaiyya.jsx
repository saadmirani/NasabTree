...
import kharbaiyyaData from "../data/Naskharbaiyya.json";
...
// ==================== CONFIGURATION ====================
const QASBA_CONFIG = {
   qasbaName: "Qasba Kharbaiyya",
   defaultFocusId: "p30",
   jsonData: kharbaiyyaData
};
// ==========================================================


export default function NasabKharbaiyya({ setSection, focusPersonId }) {
   ...
   return (
      <div className="nasab-wrapper">
         <Helmet>
            <title>Qasba Kharbaiyya - Genealogical Family Tree | Aal-e-Miran</title>
            <meta name="description" content="Interactive genealogical family tree for Qasba Kharbaiyya. Search for ancestors, descendants, biographical information, dates, and family relationships." />
            <meta name="keywords" content="Qasba Kharbaiyya, genealogy, family tree, ancestors, descendants, genealogical records" />
            <meta property="og:title" content="Qasba Kharbaiyya - Family Tree" />
            <meta property="og:description" content="Explore the genealogical family tree of Qasba Kharbaiyya with detailed biographical information." />
            <script type="application/ld+json">
               {JSON.stringify(generateFamilyTreeSchema(kharbaiyyaData, QASBA_CONFIG.qasbaName))}
            </script>
            <script type="application/ld+json">
