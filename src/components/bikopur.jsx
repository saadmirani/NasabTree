...
import bikopurData from "../data/Nasbikopur.json";
import familyInfo from "../data/familyInfo/bikopur.json";
...
// ==================== CONFIGURATION ====================
const QASBA_CONFIG = {
   qasbaName: "Qasba Bikopur",
   defaultFocusId: "p53",
   jsonData: bikopurData
};
// ==========================================================


export default function Bikopur({ setSection, focusPersonId }) {
   ...
   return (
      <div className="nasab-wrapper">
         <Helmet>
            <title>Qasba Bikopur - Genealogical Family Tree | Aal-e-Miran</title>
            <meta name="description" content="Interactive genealogical family tree for Qasba Bikopur. Search for ancestors, descendants, biographical information, dates, and family relationships." />
            <meta name="keywords" content="Qasba Bikopur, genealogy, family tree, ancestors, descendants, genealogical records" />
            <meta property="og:title" content="Qasba Bikopur - Family Tree" />
            <meta property="og:description" content="Explore the genealogical family tree of Qasba Bikopur with detailed biographical information." />
            <script type="application/ld+json">
               {JSON.stringify(generateFamilyTreeSchema(bikopurData, QASBA_CONFIG.qasbaName))}
            </script>
            <script type="application/ld+json">
