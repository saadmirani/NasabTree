...
export default function NasabMiranBigha({ setSection, focusPersonId }) {
   ...
   return (
      <div className="nasab-wrapper">
         <Helmet>
            <title>Qasba Miran Bigha - Genealogical Family Tree | Aal-e-Miran</title>
            <meta name="description" content="Interactive genealogical family tree for Qasba Miran Bigha. Search for ancestors, descendants, biographical information, dates, and family relationships." />
            <meta name="keywords" content="Qasba Miran Bigha, genealogy, family tree, ancestors, descendants, genealogical records" />
            <meta property="og:title" content="Qasba Miran Bigha - Family Tree" />
            <meta property="og:description" content="Explore the genealogical family tree of Qasba Miran Bigha with detailed biographical information." />
            <meta property="og:type" content="website" />
            <script type="application/ld+json">
               {JSON.stringify(generateFamilyTreeSchema(miranBighaData, QASBA_CONFIG.qasbaName))}
            </script>
            <script type="application/ld+json">
