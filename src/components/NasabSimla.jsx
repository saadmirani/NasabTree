...
import simlaData from "../data/Nassimla.json";
import familyInfo from "../data/familyInfo/simla.json";
...
export default function NasabSimla({ setSection, focusPersonId }) {
   ...
   return (
      <div className="nasab-wrapper">
         <Helmet>
            <title>Qasba Simla - Genealogical Family Tree | Aal-e-Miran</title>
            <meta name="description" content="Interactive genealogical family tree for Qasba Simla. Search for ancestors, descendants, biographical information, dates, and family relationships." />
            <meta name="keywords" content="Qasba Simla, genealogy, family tree, ancestors, descendants, genealogical records" />
            <meta property="og:title" content="Qasba Simla - Family Tree" />
            <meta property="og:description" content="Explore the genealogical family tree of Qasba Simla with detailed biographical information." />
            <script type="application/ld+json">
               {JSON.stringify(generateFamilyTreeSchema(simlaData, QASBA_CONFIG.qasbaName))}
            </script>
            <script type="application/ld+json">
