...
// ==================== CONFIGURATION ====================
const QASBA_CONFIG = {
   qasbaName: "Qasba Ahmadpur",
   defaultFocusId: "p76",
   jsonData: ahmadpurData
};
// ==========================================================
...
export default function NasabAhmadpur({ setSection }) {
   ...
   return (
      <div className="nasab-wrapper">
         <Helmet>
            <title>Qasba Ahmadpur - Genealogical Family Tree | Aal-e-Miran</title>
            <meta name="description" content="Interactive genealogical family tree for Qasba Ahmadpur. Search for ancestors, descendants, biographical information, dates, and family relationships." />
            <meta name="keywords" content="Qasba Ahmadpur, genealogy, family tree, ancestors, descendants, genealogical records" />
            <meta property="og:title" content="Qasba Ahmadpur - Family Tree" />
            <meta property="og:description" content="Explore the genealogical family tree of Qasba Ahmadpur with detailed biographical information." />
            <script type="application/ld+json">
               {JSON.stringify(generateFamilyTreeSchema(ahmadpurData, QASBA_CONFIG.qasbaName))}
            </script>
            <script type="application/ld+json">
